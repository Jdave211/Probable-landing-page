...
export function WorldMap({
  ...
  const theme = "dark"; // Force dark mode for this site
  ...
  return (
    <div className="w-full aspect-[2/1] bg-transparent rounded-lg relative font-sans overflow-hidden">
      <img
        ...
        className="absolute inset-0 h-full w-full object-contain [mask-image:linear-gradient(to_bottom,transparent,white_10%,white_90%,transparent)] pointer-events-none select-none"
        alt="world map"
        width="800"
        height="400"
        draggable={false}
